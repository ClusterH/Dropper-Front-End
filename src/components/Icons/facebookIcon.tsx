...
const FacebookIcon: React.FC<SvgProps> = ({ width = '24px', height = '24px', color = 'white', style }) => (
  <svg width={width} height={height} viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
    <path
